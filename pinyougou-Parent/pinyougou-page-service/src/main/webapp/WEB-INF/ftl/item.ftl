...
<!--属性列表 custom_attribute_items  转为JSON对象 -->
                        ...
                        <#list specificationItems as item>
                            <dl>
                                ...
                                <#list item.attributeValue as value>
                                    <dd><a href="javascript:void(0)"  class="{{isSelectSpec('${item.attributeName}','${value}')?'selected':''}}"
                                           ng-click="selectSpec('${item.attributeName}','${value}')" >${value}
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="cart.html" target="_blank" ng-click="addToCat()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
